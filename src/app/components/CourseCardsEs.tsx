...
const courses: Course[] = [
  {
    ...
    slug: "cpr-first-aid",
    price: "$65",
    accred: "Acreditado por HSI",
    renew: "Cada 2 años",
    subtitle: "Adultos, niños y lactantes",
    img: "/cpr2.jpg",
    bullets: [
      "El curso se imparte en inglés y en español",
      "RCP, uso de DEA y alivio de atragantamiento",
      "Control de hemorragias y manejo del shock",
      "Quemaduras, fracturas y posición de recuperación",
      "Seguridad de la escena y EPP; precauciones universales",
      "Certificado emitido al finalizar",
    ],
  },
  {
    ...
    bullets: [
      ...
      "Vías y formas; medición y dosificación precisa",
      "Almacenamiento, seguridad y desecho",
      "Control de infecciones y prevención de errores",
    ],
  },
  {
    ...
    bullets: [
      ...
      "Tiempo/temperatura y control de alimentos TCS",
      "Gestión de alérgenos y cruce de contacto",
      "Recepción, almacenamiento y rotulado (PEPS/FIFO)",
      "Limpieza, desinfección y cuidado de equipos",
    ],
  },
];
